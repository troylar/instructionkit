...
from instructionkit.core.models import InstallationScope, MCPTemplate
...
class MCPManager:
    ...
    def _parse_metadata(self, template_path: Path) -> dict:
        """
        Parse template metadata from instructionkit.yaml.
        ...
        metadata_file = template_path / "instructionkit.yaml"
